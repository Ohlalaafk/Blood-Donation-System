...
const getStatusBadge = (status: RequestStatus) => {
  switch (status) {
    ...
    case 'urgent':
      return <Badge variant="outline" className="flex items-center gap-1 bg-red-100 text-red-700 border-red-300"><AlertTriangle className="h-3 w-3" /> Urgent</Badge>;
    default:
    ...
    <Card className="w-full h-full bg-white shadow-sm">
      <CardHeader className="pb-2">
        <div className="flex justify-between items-center">
          <CardTitle className="text-lg font-semibold">Blood Requests</CardTitle>
